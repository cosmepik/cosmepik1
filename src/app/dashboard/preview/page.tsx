      ...
      <div className="mx-auto max-w-md px-4 pb-4 pt-6">
        <div className="mb-4 flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground shadow-md transition-all hover:bg-primary/90 active:scale-95"
          >
            {publishedMessage ? (
              <>
