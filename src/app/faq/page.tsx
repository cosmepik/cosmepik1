...
const FAQ_ITEMS = [
  ...
  {
    q: "コスメはどうやって追加しますか？",
    a: "ダッシュボードで「コスメを追加」から、商品名・カテゴリなどで検索して追加できます。気になる商品を選び、愛用コメントを付けてグループに並べられます。ルーティン（朝・夜のケア順）として並べることもできます。",
  },
  {
    q: "確認メールが届きません",
  ...
  {
    q: "その他、質問や要望がある",
    a: "ご不明点・ご要望はお問い合わせページ、または info@cosmepik.me までお気軽にどうぞ。返信までお時間をいただく場合があります。",
  },
];
