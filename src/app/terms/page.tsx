            ...
            <div className="space-y-4">
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-1 text-muted-foreground leading-relaxed">
                  ...
                  <li>運営者は、本サービスの提供・改善・運営に必要な範囲において、ユーザーが作成したコスメページの情報（登録コスメ情報、レイアウト設定、アクセス状況等）を取得・利用することがあります。取得した情報の取扱いについては、<Link href="/privacy" className="font-medium text-primary underline underline-offset-2 hover:opacity-80">プライバシーポリシー</Link>に従うものとします。</li>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-1 text-muted-foreground leading-relaxed">
                  ...
                  <li>本サービスはアフィリエイト報酬の発生を100%保証するものではありません。</li>
                  <li>通信環境、ブラウザの設定（クッキー無効等）、システムの不具合により報酬が発生しなかった場合、運営者は一切の補填義務を負わないものとします。</li>
                  <li>本サービスはベータ版（開発途上版）であり、予期せぬバグが発生する可能性があることを承諾して利用するものとします。</li>
                </ol>
              </div>
