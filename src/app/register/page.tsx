        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              autoComplete="email"
              enterKeyHint="next"
              className="w-full rounded-lg border border-input bg-white px-4 py-2.5 text-card-foreground outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors"
          ...
          <button
            ...
            className="w-full rounded-lg bg-green py-3 font-medium text-white hover:opacity-90 active:scale-[0.98] disabled:opacity-50 transition-all"
          >
