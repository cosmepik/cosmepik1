...
import { getMyList } from "@/lib/local-storage";
...
/**
 * ファン向け公開プロフィールページ
 * /[username] でアクセス。現状は localStorage のデータを表示するため
 * 同一ブラウザでしか正しく表示されません。デモ用に /demo でも同じUIを表示。
 */
    ...
    <main className="min-h-screen bg-cream-50">
      <div className="max-w-lg mx-auto px-4 py-10">
        ...
        <footer className="mt-12 text-center">
          <p className="text-xs text-stone-400">Powered by Cosmetree</p>
        </footer>
      </div>
    </main>
  );
