      ...
      {open && (
        <>
          ...
          <div
            ...
            className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[min(95vw,40rem)] md:max-h-[90dvh] z-50 flex flex-col bg-white rounded-2xl shadow-2xl border border-cream-300 overflow-hidden"
          >
